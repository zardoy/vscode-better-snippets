...
import { registerSnippetsFromDirs } from './snippetsDirs'
...
export const activate = () => {
    ...
    const registerSnippets = () => {
        ...
        // TODO! move this out of this fn as changing any snippet settings would force reload all snippets from disk
        registerSnippetsFromDirs(registerSnippets)
